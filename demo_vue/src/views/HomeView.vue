  ...
  <div>
    <section class="hero-section" id="section_1">
      ...
      <div class="video-wrap">
        <video autoplay="false" loop="false" muted="false" class="custom-video" poster="">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 text-center">
            <h2 class="mb-4">Conoce a Nuestros Artistas</h2>
          </div>

          <div v-for="artista in artistas" :key="artista.id" class="col-lg-4 col-md-6 col-12 mb-4">
            <Card>
              <template #header>
                <img
                  alt="user header"
